...
mod x86_64 {
    ...
    unsafe impl Int8DotIsa for Avx512VnniIsa {
        ...
        fn dot(
            ...
            // LLVM 21 (used by the pinned Nix rustc) rejects the signature
            // emitted for this intrinsic. The identical instruction is also
            // used via inline asm in kernels/x86_64.rs, and the runtime ISA
            // check above ensures it is safe to execute here.
            use std::arch::asm;
