...
|---|---:|---:|---:|---|
| Native controller source adapters | 46 | 250 standalone candidates | 18.4% | 204 catalog candidates still lack a registered partial adapter |
| RetroArch core source contracts | 94 | 94 core names | 100.0% | Source contracts are complete; runtime verification remains |
| Combined controller source entries | 140 | 344 catalog runtimes | 40.7% | 46 native adapters plus 94 core contracts; record-only simple64 is tracked separately |
