...
|---|---:|---:|---:|---|
| Native controller source adapters | 57 | 250 standalone candidates | 22.8% | 193 catalog candidates still lack a registered partial adapter |
| RetroArch core source contracts | 94 | 94 core names | 100.0% | Source contracts are complete; runtime verification remains |
| Combined controller source entries | 151 | 344 catalog runtimes | 43.9% | 57 native adapters plus 94 core contracts; record-only simple64 is tracked separately |
