...
|---|---:|---:|---:|---|
| Native controller source adapters | 52 | 250 standalone candidates | 20.8% | 198 catalog candidates still lack a registered partial adapter |
| RetroArch core source contracts | 94 | 94 core names | 100.0% | Source contracts are complete; runtime verification remains |
| Combined controller source entries | 146 | 344 catalog runtimes | 42.4% | 52 native adapters plus 94 core contracts; record-only simple64 is tracked separately |
