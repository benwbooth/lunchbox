...
|---|---:|---:|---:|---|
| Native controller source adapters | 75 | 250 standalone candidates | 30.0% | 175 catalog candidates still lack a registered partial adapter |
| RetroArch core source contracts | 94 | 94 core names | 100.0% | Source contracts are complete; runtime verification remains |
| Combined controller source entries | 169 | 344 catalog runtimes | 49.1% | 75 native adapters plus 94 core contracts; record-only simple64 is tracked separately |
