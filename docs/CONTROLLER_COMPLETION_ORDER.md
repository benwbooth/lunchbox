...
Update 2026-09-10: Stella 7.x standalone Atari 2600 dispatch was added
(`STELLA_NATIVE_CONTROLLER_CONTRACT.md`), bringing the native adapter list to
seventeen. Update 2026-09-09: bsnes v115 standalone SNES gamepad dispatch was added
...
Next: continue ordinary standalone gamepad configuration beyond these seventeen;
