                ...
                profile.status == "documented"
                    && matches!(
                        ...
                        "retropad"
                            ...
                            | "86box-native-settings"
                            | "a7800-native-settings"
                            | "gambatte-native-settings"
                            | "picodrive-native-settings"
                            | "nestopia-ue-native-settings"
                            | "skyemu-native-settings"
                            | "linapple-native-settings"
                            | "fuse-native-settings"
                            | "amiberry-native-settings"
                            | "gbe-plus-native-settings"
                            | "pokemini-native-settings"
                            | "uzem-native-settings"
                            | "eka2l1-native-settings"
                            | "cemu-native-settings"
                            | "azahar-native-settings"
                            | "shadps4-native-settings"
                            | "ymir-native-settings"
                            | "dreampotato-native-settings"
                            | "panda3ds-native-settings"
                            | "supermodel-native-settings"
                            | "openbor-native-settings"
                            | "touchhle-native-settings"
                            | "tsugaru-native-settings"
                            | "pcem-native-settings"
                            | "simcoupe-native-settings"
                            | "vector06sdl-native-settings"
                            | "adamem-native-settings"
                            | "ep128emu-native-settings"
                            | "play-native-settings"
                            ...
                            | "dosbox-x-native-settings"
                            | "dosbox-staging-native-settings"
                    ),
...
impl Calibration {
    ...
    pub(crate) fn plan_profile(&self, profile: &EmulatorProfile) -> Result<MappingPlan> {
        ...
        warnings.push(if profile.transport == "ares-settings" {
            ...
            "DOSBox binds the measured controller to the emulated PC joystick through a private mapper and preserves the emulator's keyboard defaults. The preview does not establish runtime readiness; games that read the keyboard or mouse only are not redirected."
...
pub fn svg(layout: &Layout, active: &str) -> String {
    let outline = match layout.shape.as_str() {
        ...
        "rectangle" => {
            "M70 60H830Q850 60 850 85V365Q850 390 820 390H80Q50 390 50 365V85Q50 60 70 60Z"
        }
        "handheld" => "M70 40H830V355Q830 420 760 420H140Q70 420 70 355V40Z",
        "three-grip" => {
            "M190 50L710 50Q825 50 833 125L848 390Q850 448 782 402L650 270L505 300L496 424Q493 480 450 480Q407 480 404 424L395 300L250 270L118 402Q50 448 52 390L67 125Q75 50 190 50Z"
        }
        _ => {
            "M110 80Q140 40 280 70L620 70Q760 40 790 80L855 365Q860 440 790 400L650 295H250L110 400Q40 440 45 365Z"
        }
    };
    let mut svg = format!(
