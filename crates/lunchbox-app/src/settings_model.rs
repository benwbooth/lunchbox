...
pub mod qobject {
    ...
    unsafe extern "RustQt" {
        ...
        #[qinvokable]
        fn eighty_six_box_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn review_eighty_six_box_native_setups(
            self: &SettingsModel,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn stage_eighty_six_box_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn a7800_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn gambatte_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn picodrive_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn nestopia_ue_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn skyemu_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn linapple_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn fuse_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn amiberry_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn gbe_plus_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn pokemini_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn uzem_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn eka2l1_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn cemu_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn azahar_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn shadps4_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn ymir_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn dreampotato_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn panda3ds_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn supermodel_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn openbor_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn touchhle_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn tsugaru_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn pcem_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn simcoupe_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn vector06sdl_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn adamem_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn review_adamem_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_adamem_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_vector06sdl_native_setups(
            self: &SettingsModel,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn stage_vector06sdl_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_simcoupe_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_simcoupe_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn ep128emu_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn review_ep128emu_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_ep128emu_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_pcem_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_pcem_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_tsugaru_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_tsugaru_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_touchhle_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_touchhle_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_openbor_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_openbor_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_supermodel_native_setups(self: &SettingsModel, configuration: QString)
        -> QString;
        #[qinvokable]
        fn stage_supermodel_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_panda3ds_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_panda3ds_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        ...
        #[qinvokable]
        fn stage_dreampotato_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_ymir_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_ymir_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_shadps4_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_shadps4_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_azahar_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_azahar_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_cemu_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_cemu_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_eka2l1_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_eka2l1_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_uzem_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_uzem_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_pokemini_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_pokemini_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_gbe_plus_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_gbe_plus_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn vita3k_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn review_vita3k_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_vita3k_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_amiberry_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_amiberry_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_fuse_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_fuse_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn caprice32_native_setups_json(self: &SettingsModel) -> QString;
        #[qinvokable]
        fn review_caprice32_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_caprice32_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_linapple_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_linapple_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_skyemu_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_skyemu_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn review_nestopia_ue_native_setups(
            self: &SettingsModel,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        fn stage_nestopia_ue_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
        ...
        #[qinvokable]
        fn review_a7800_native_setups(self: &SettingsModel, configuration: QString) -> QString;
        #[qinvokable]
        fn stage_a7800_native_setups(
            self: Pin<&mut SettingsModel>,
            configuration: QString,
        ) -> QString;
        #[qinvokable]
...
impl qobject::SettingsModel {
    ...
    pub fn eighty_six_box_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(
                &self
                    .rust()
            ...
            .expect("86Box native setups serialize"),
        )
    }

    pub fn review_eighty_six_box_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "86Box native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_86box_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_86box_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_eighty_six_box_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_86box_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "86Box native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .eighty_six_box_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn a7800_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.a7800_native_launches)
                .expect("A7800 native setups serialize"),
        )
    }

    pub fn review_a7800_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "A7800 native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_a7800_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_a7800_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_a7800_native_setups(mut self: Pin<&mut Self>, configuration: QString) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_a7800_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "A7800 native setup text exceeds size limit"
    ...
    pub fn gambatte_native_setups_json(&self) -> QString {
        qstring(
    ...
    pub fn nestopia_ue_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(
                &self.rust().controller_mapping.nestopia_ue_native_launches,
            )
            .expect("Nestopia native setups serialize"),
        )
    }

    pub fn skyemu_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.skyemu_native_launches)
                .expect("SkyEmu native setups serialize"),
        )
    }

    pub fn linapple_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.linapple_native_launches)
                .expect("LinApple native setups serialize"),
        )
    }

    pub fn caprice32_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.caprice32_native_launches)
                .expect("Caprice32 native setups serialize"),
        )
    }

    pub fn review_caprice32_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Caprice32 native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_caprice32_standalone::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_caprice32_standalone::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_caprice32_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_caprice32_standalone::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Caprice32 native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .caprice32_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn fuse_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.fuse_native_launches)
                .expect("Fuse native setups serialize"),
        )
    }

    pub fn amiberry_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.amiberry_native_launches)
                .expect("Amiberry native setups serialize"),
        )
    }

    pub fn vita3k_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.vita3k_native_launches)
                .expect("Vita3K native setups serialize"),
        )
    }

    pub fn review_vita3k_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Vita3K native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_vita3k_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_vita3k_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_vita3k_native_setups(mut self: Pin<&mut Self>, configuration: QString) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_vita3k_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Vita3K native setup text exceeds size limit"
    ...
    pub fn gbe_plus_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.gbe_plus_native_launches)
                .expect("GBE+ native setups serialize"),
        )
    }

    pub fn pokemini_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.pokemini_native_launches)
                .expect("PokeMini native setups serialize"),
        )
    }

    pub fn uzem_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.uzem_native_launches)
                .expect("Uzem native setups serialize"),
        )
    }

    pub fn eka2l1_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.eka2l1_native_launches)
                .expect("EKA2L1 native setups serialize"),
        )
    }

    pub fn cemu_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.cemu_native_launches)
                .expect("Cemu native setups serialize"),
        )
    }

    pub fn azahar_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.azahar_native_launches)
                .expect("Azahar native setups serialize"),
        )
    }

    pub fn shadps4_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.shadps4_native_launches)
                .expect("shadPS4 native setups serialize"),
        )
    }

    pub fn ymir_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.ymir_native_launches)
                .expect("Ymir native setups serialize"),
        )
    }

    pub fn dreampotato_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(
                &self.rust().controller_mapping.dreampotato_native_launches,
            )
    ...
    pub fn panda3ds_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.panda3ds_native_launches)
                .expect("Panda3DS native setups serialize"),
        )
    }

    pub fn supermodel_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(
                &self.rust().controller_mapping.supermodel_native_launches,
            )
            .expect("Supermodel native setups serialize"),
        )
    }

    pub fn openbor_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.openbor_native_launches)
                .expect("OpenBOR native setups serialize"),
        )
    }

    pub fn touchhle_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.touchhle_native_launches)
                .expect("touchHLE native setups serialize"),
        )
    }

    pub fn tsugaru_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.tsugaru_native_launches)
                .expect("Tsugaru native setups serialize"),
        )
    }

    pub fn pcem_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.pcem_native_launches)
                .expect("PCem native setups serialize"),
        )
    }

    pub fn ep128emu_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.ep128emu_native_launches)
                .expect("ep128emu native setups serialize"),
        )
    }

    pub fn review_ep128emu_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "ep128emu native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_ep128emu_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_ep128emu_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_ep128emu_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_ep128emu_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "ep128emu native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .ep128emu_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn simcoupe_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.simcoupe_native_launches)
                .expect("SimCoupe native setups serialize"),
        )
    }

    pub fn vector06sdl_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(
                &self.rust().controller_mapping.vector06sdl_native_launches,
            )
            .expect("vector06sdl native setups serialize"),
        )
    }

    pub fn adamem_native_setups_json(&self) -> QString {
        qstring(
            serde_json::to_string_pretty(&self.rust().controller_mapping.adamem_native_launches)
                .expect("ADAMEm native setups serialize"),
        )
    }

    pub fn review_adamem_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "ADAMEm native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_adamem_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_adamem_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_adamem_native_setups(mut self: Pin<&mut Self>, configuration: QString) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_adamem_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "ADAMEm native setup text exceeds size limit"
    ...
    pub fn review_vector06sdl_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "vector06sdl native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_vector06sdl_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_vector06sdl_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_vector06sdl_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_vector06sdl_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "vector06sdl native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .vector06sdl_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_simcoupe_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "SimCoupe native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_simcoupe_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_simcoupe_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_simcoupe_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_simcoupe_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "SimCoupe native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .simcoupe_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_pcem_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "PCem native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_pcem_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_pcem_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_pcem_native_setups(mut self: Pin<&mut Self>, configuration: QString) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_pcem_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "PCem native setup text exceeds size limit"
    ...
    pub fn review_tsugaru_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Tsugaru native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_tsugaru_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_tsugaru_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_tsugaru_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_tsugaru_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Tsugaru native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .tsugaru_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_touchhle_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "touchHLE native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_touchhle_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_touchhle_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_touchhle_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_touchhle_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "touchHLE native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .touchhle_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_openbor_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "OpenBOR native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_openbor_standalone::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_openbor_standalone::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_openbor_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_openbor_standalone::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "OpenBOR native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .openbor_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_supermodel_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Supermodel native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_supermodel_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_supermodel_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_supermodel_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_supermodel_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Supermodel native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .supermodel_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_panda3ds_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Panda3DS native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_panda3ds_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_panda3ds_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_panda3ds_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_panda3ds_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Panda3DS native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .panda3ds_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_dreampotato_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            ...
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "DreamPotato native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_dreampotato_standalone::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_dreampotato_standalone::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_dreampotato_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_dreampotato_standalone::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "DreamPotato native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .dreampotato_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_ymir_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Ymir native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_ymir_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_ymir_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_ymir_native_setups(mut self: Pin<&mut Self>, configuration: QString) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_ymir_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Ymir native setup text exceeds size limit"
    ...
    pub fn review_shadps4_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "shadPS4 native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_shadps4_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_shadps4_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_shadps4_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_shadps4_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "shadPS4 native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .shadps4_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_azahar_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Azahar native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_azahar_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_azahar_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_azahar_native_setups(mut self: Pin<&mut Self>, configuration: QString) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_azahar_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Azahar native setup text exceeds size limit"
    ...
    pub fn review_cemu_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Cemu native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_cemu_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_cemu_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_cemu_native_setups(mut self: Pin<&mut Self>, configuration: QString) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_cemu_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Cemu native setup text exceeds size limit"
    ...
    pub fn review_eka2l1_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "EKA2L1 native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_eka2l1_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_eka2l1_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_eka2l1_native_setups(mut self: Pin<&mut Self>, configuration: QString) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_eka2l1_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "EKA2L1 native setup text exceeds size limit"
    ...
    pub fn review_uzem_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Uzem native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_uzem_standalone::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_uzem_standalone::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_uzem_native_setups(mut self: Pin<&mut Self>, configuration: QString) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_uzem_standalone::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Uzem native setup text exceeds size limit"
    ...
    pub fn review_pokemini_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "PokeMini native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_pokemini_standalone::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_pokemini_standalone::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_pokemini_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_pokemini_standalone::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "PokeMini native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .pokemini_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_gbe_plus_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "GBE+ native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_gbe_plus_standalone::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_gbe_plus_standalone::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_gbe_plus_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_gbe_plus_standalone::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "GBE+ native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .gbe_plus_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_amiberry_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Amiberry native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_amiberry_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_amiberry_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_amiberry_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_amiberry_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Amiberry native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .amiberry_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_fuse_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Fuse native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_fuse_standalone::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_fuse_standalone::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_fuse_native_setups(mut self: Pin<&mut Self>, configuration: QString) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_fuse_standalone::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Fuse native setup text exceeds size limit"
    ...
    pub fn review_linapple_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "LinApple native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_linapple_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_linapple_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_linapple_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_linapple_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "LinApple native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .linapple_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_skyemu_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "SkyEmu native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_skyemu_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_skyemu_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_skyemu_native_setups(mut self: Pin<&mut Self>, configuration: QString) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_skyemu_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "SkyEmu native setup text exceeds size limit"
    ...
    pub fn review_nestopia_ue_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            let text = configuration.to_string();
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Nestopia native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_nestopia_ue_native::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_nestopia_ue_native::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_nestopia_ue_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_nestopia_ue_native::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Nestopia native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .nestopia_ue_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
    ...
    pub fn review_gambatte_native_setups(&self, configuration: QString) -> QString {
        let result = (|| -> anyhow::Result<Vec<serde_json::Value>> {
            ...
            anyhow::ensure!(
                text.len() <= 2 * 1024 * 1024,
                "Gambatte native setup text exceeds size limit"
            );
            let setups: Vec<crate::controller_gambatte_standalone::settings::SavedSetup> =
                serde_json::from_str(&text)?;
            crate::controller_gambatte_standalone::settings::validate_setups(&setups)?;
            setups
                .iter()
                .map(|setup| setup.review(&self.rust().controller_mapping.calibrations))
                .collect()
    ...
    pub fn stage_gambatte_native_setups(
        mut self: Pin<&mut Self>,
        configuration: QString,
    ) -> QString {
        let result =
            (|| -> anyhow::Result<Vec<crate::controller_gambatte_standalone::settings::SavedSetup>> {
                let text = configuration.to_string();
                anyhow::ensure!(
                    text.len() <= 2 * 1024 * 1024,
                    "Gambatte native setup text exceeds size limit"
        ...
        match result {
            Ok(setups) => {
                self.as_mut()
                    .rust_mut()
                    .controller_mapping
                    .gambatte_native_launches = setups;
                self.as_mut().controller_settings_changed();
                qstring("")
            }
            Err(error) => qstring(format!("{error:#}")),
