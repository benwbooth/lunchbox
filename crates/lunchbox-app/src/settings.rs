...
pub struct ControllerMappingSettings {
    ...
    #[serde(default)]
    pub(crate) hatari_native_launches: Vec<crate::controller_hatari_native::settings::SavedSetup>,
    #[serde(default)]
    pub(crate) desmume_native_launches: Vec<crate::controller_desmume_native::settings::SavedSetup>,
    #[serde(default)]
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub(crate) a7800_native_launches: Vec<crate::controller_a7800_native::settings::SavedSetup>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub(crate) gambatte_native_launches:
        Vec<crate::controller_gambatte_standalone::settings::SavedSetup>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    ...
    pub(crate) touchhle_native_launches:
        Vec<crate::controller_touchhle_native::settings::SavedSetup>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub(crate) openbor_native_launches:
        Vec<crate::controller_openbor_standalone::settings::SavedSetup>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub(crate) supermodel_native_launches:
        Vec<crate::controller_supermodel_native::settings::SavedSetup>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub(crate) panda3ds_native_launches:
        Vec<crate::controller_panda3ds_native::settings::SavedSetup>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub(crate) dreampotato_native_launches:
        Vec<crate::controller_dreampotato_standalone::settings::SavedSetup>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub(crate) ymir_native_launches: Vec<crate::controller_ymir_native::settings::SavedSetup>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
...
impl Default for ControllerMappingSettings {
    fn default() -> Self {
        Self {
            ...
            supermodel_native_launches: Vec::new(),
            panda3ds_native_launches: Vec::new(),
...
impl ControllerMappingSettings {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        crate::controller_a7800_native::settings::validate_setups(&self.a7800_native_launches)?;
        crate::controller_gambatte_standalone::settings::validate_setups(
            &self.gambatte_native_launches,
        )?;
        ...
        crate::controller_openbor_standalone::settings::validate_setups(
            &self.openbor_native_launches,
        )?;
        crate::controller_supermodel_native::settings::validate_setups(
            &self.supermodel_native_launches,
        )?;
        crate::controller_panda3ds_native::settings::validate_setups(
            &self.panda3ds_native_launches,
        )?;
        crate::controller_dreampotato_standalone::settings::validate_setups(
            &self.dreampotato_native_launches,
        )?;
        crate::controller_ymir_native::settings::validate_setups(&self.ymir_native_launches)?;
