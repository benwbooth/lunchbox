        ...
        onTriggered: {
            ...
            if (root.couchGamepadProbeStage === 1) {
                ...
                if (!couchModeView.overlayOpen
                    ...
                    console.error("LUNCHBOX_COUCH_GAMEPAD_UI_FAILED releases wheel close")
                    Qt.exit(2)
                    return
                }
                ...
                if (couchModeView.menuActionIndex !== 5) {
